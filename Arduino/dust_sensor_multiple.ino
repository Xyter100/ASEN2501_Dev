...
int latest_reading_0 = 0;         // the latest reading on dust sensor 0
int latest_reading_1 = 0;         // the latest reading on dust sensor 1
...
{    
  ...
  attachInterrupt(1, takeReading, RISING);
}

// Dust sample interrupt service routine
void takeReading() {
   // read from the sensor:
   latest_reading_0 = analogRead(dustPin0);
   latest_reading_1 = analogRead(dustPin1);
}
